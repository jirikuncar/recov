...
def extract_coverage_data(
    ...
    with console.status(
        ...
        try:
            ...
            console.print(
                f"[yellow]Warning: Could not process coverage data: {e}[/yellow]"
            )
            return {}, set(), False
        ...
        if not test_coverage:
            ...
            console.print(
                "[yellow]Ensure pytest was run with --cov-context=test[/yellow]"
            )
            return {}, set(), False
...
def calculate_redundancy_analysis(
    ...
    with console.status(
        ...
        for test_context in test_contexts:
            ...
            is_redundant = lines_redundant and (
                arcs_redundant if with_branches else True
            )
...
def format_and_display_results(
    ...
    for result in test_results:
        ...
        status = (
            "[bold red]REDUNDANT[/bold red]"
            if result["is_redundant"]
            else "[green]UNIQUE[/green]"
        )
